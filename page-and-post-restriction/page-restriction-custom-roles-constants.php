...
class papr_custom_roles_constants {
	...
	public static function papr_custom_roles_capabilities_constants() {
		...
		$papr_capabilites_category_array['general'] = array(
			'edit_dashboard',
			'edit_files',
			'export',
			'import',
		...
		$papr_capabilites_category_array['post'] = array(
			'delete_others_posts',
			'delete_posts',
		...
		$papr_capabilites_category_array['page'] = array(
			'delete_others_pages',
			'delete_pages',
		...
		$papr_capabilites_category_array['appearance'] = array(
			'delete_themes',
			'edit_theme_options',
			'edit_themes',
			'install_themes',
		...
		$papr_capabilites_category_array['plugins'] = array(
			'activate_plugins',
			'delete_plugins',
			'edit_plugins',
			'install_plugins',
		...
		$papr_capabilites_category_array['users'] = array(
			'create_roles',
			'create_users',
			'delete_roles',
			'delete_users',
