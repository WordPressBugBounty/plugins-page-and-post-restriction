		...
		<div class="wrap shadow-cstm p-3 me-0 mt-0 mo-saml-margin-left bg-white" id="nav-market">
			<div class="row align-items-center">
				...
				<div class="col-md-3 text-center">
					<a id="license_upgrade" class="text-white ps-4 pe-4 pt-2 pb-2 papr-prem-btn" href="<?php echo esc_url( Papr_Plugin_Links::PREMIUM_PLANS ); ?>" target="_blank">Premium Plans | Upgrade Now</a>
				</div>
