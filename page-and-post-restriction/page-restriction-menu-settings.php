...
require_once 'page-restriction-tag-access.php';
require_once 'page-restriction-category-access.php';
	...
	<div class="wrap shadow-cstm p-3 me-0 mt-0 mo-saml-margin-left bg-white">
		<div class="row align-items-center">
			...
			<div class="col-md-7 d-flex align-items-center justify-content-end">
				<a id="license_upgrade" class="me-3 text-white ps-5 pe-5 pt-3 pb-3 papr-prem-btn" href="<?php echo esc_url( Papr_Plugin_Links::PREMIUM_PLANS ); ?>" target="_blank">Premium Plans</a>
	...
	<div class="rounded bg-white papr-shadow p-4 mt-4 ms-4">
		...
		<div class="papr-prem-info">
			<div class="papr-prem-icn" style="margin-left:31em;"><img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) ); ?>includes/images/lock.png" width="35px" />
				<p class="papr-prem-info-text">Available in <b>Paid</b> versions of the plugin. <a href="<?php echo esc_url( Papr_Plugin_Links::PREMIUM_PLANS ); ?>" target="_blank">Click here to upgrade</a></p>
			</div>
			<div class="row">
		...
		<div style="padding: 10px;">
			...
			<table>
				<tr>
					...
					<td>
						<a href="<?php echo esc_url( Papr_Plugin_Links::PREMIUM_PLANS ); ?>" target="_blank"><input type="button" class="btn papr-btn-cstm rounded" value="Check Premium Plans" /></a>
					</td>
				</tr>
			</table>
		</div>
